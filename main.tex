...
investigation phase of Madonna, while we were adding support for Assistance in MADONNA.
...
FPTuner is a reserach tool for rigorous floating point tuning. Adding support for 16-bit Floating point is quite easy, 
it involves changing the wrapper scripts to FPTuner, and not its core search + optimization logic.
